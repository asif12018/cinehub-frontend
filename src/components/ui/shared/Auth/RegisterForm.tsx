      ...
      <CardContent className="px-0">
          ...
          >
            {(field) => (
              <div className="flex flex-col gap-2 mt-4">
                ...
                >
                  <SelectTrigger className="w-full bg-[#333] border-none text-foreground h-[48px] rounded-[4px] px-5 focus:ring-0 focus:border-b-2 focus:border-[#e87c03] focus:rounded-b-none transition-all">
                    <SelectValue placeholder="Select Gender" />
                  </SelectTrigger>
                  <SelectContent className="bg-[#333] text-foreground border-border">
                    <SelectItem value="MALE" className="cursor-pointer hover:bg-gray-700 focus:bg-gray-700 focus:text-foreground">MALE</SelectItem>
                    <SelectItem value="FEMALE" className="cursor-pointer hover:bg-gray-700 focus:bg-gray-700 focus:text-foreground">FEMALE</SelectItem>
                  </SelectContent>
                </Select>
              ...
              <div className="flex flex-col gap-3 mt-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Input
                    ...
                    className="cursor-pointer file:text-foreground file:bg-muted file:border-0 file:mr-4 file:px-4 file:py-2 hover:file:bg-gray-700"
                    onChange={(e) => {
        ...
        <div className="relative mt-8 mb-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-black/75 sm:bg-black/80 text-[#737373]">OR</span>
          </div>
        </div>
