    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans">
      ...
      <main className="pt-28 px-4 md:px-12 pb-16 max-w-[1800px] mx-auto w-full">
        <div className="flex items-center justify-between mb-10 border-b border-gray-800 pb-6">
          ...
          <div className="hidden md:block bg-gray-900 px-4 py-2 rounded-full border border-gray-800">
             <span className="text-red-500 font-bold">{watchlistItems.length}</span>
             <span className="text-gray-400 ml-2 text-sm uppercase font-semibold">Titles</span>
          </div>
        </div>
