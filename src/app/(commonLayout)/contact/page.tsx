  ...
  return (
    <div className="min-h-screen bg-background text-foreground pt-24 pb-20 px-4 md:px-12 max-w-7xl mx-auto">
      <div className="text-center max-w-2xl mx-auto mb-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <h1 className="text-foregroundxl md:text-5xl font-bold mb-4 tracking-tight">Get in Touch</h1>
          ...
          <form className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input type="text" className="w-full bg-black/5 dark:bg-black/40 border border-border rounded-lg px-4 py-3 text-foreground focus:outline-none focus:border-red-500 transition-colors" placeholder="John" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium text-muted-foreground">Last Name</label>
                <input type="text" className="w-full bg-black/5 dark:bg-black/40 border border-border rounded-lg px-4 py-3 text-foreground focus:outline-none focus:border-red-500 transition-colors" placeholder="Doe" />
              </div>
            </div>
            
            <div className="space-y-2">
              <label className="text-sm font-medium text-muted-foreground">Email Address</label>
              <input type="email" className="w-full bg-black/5 dark:bg-black/40 border border-border rounded-lg px-4 py-3 text-foreground focus:outline-none focus:border-red-500 transition-colors" placeholder="john@example.com" />
            </div>

            <div className="space-y-2">
              <label className="text-sm font-medium text-muted-foreground">Subject</label>
              <select className="w-full bg-black/5 dark:bg-black/40 border border-border rounded-lg px-4 py-3 text-foreground focus:outline-none focus:border-red-500 transition-colors appearance-none">
            ...
            <div className="space-y-2">
              ...
              <textarea rows={4} className="w-full bg-black/5 dark:bg-black/40 border border-border rounded-lg px-4 py-3 text-foreground focus:outline-none focus:border-red-500 transition-colors resize-y" placeholder="How can we help you?"></textarea>
            </div>
